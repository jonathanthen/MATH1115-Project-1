...
#Wednesday/1pm/Carslaw 752 Computer Lab 
author: 460324384, 
date: "20/08/2019"
...
getwd() #already set to Desktop no need to change 
...
# Exploring Data 
#1) Looking at the relationship between smoker status and age of participants, Do habits change as we age? Once adictted can we cease?
# Use ggplot
library(ggplot2)
...
ggplot(nchs, aes(bmi,hdl, colour= sex)) + geom_point() + xlab ("Body Mass index (Kg/M^2)") + ylab("HDL cholesterol (mg/dL)") + ggtitle ("HDL Cholesterol and BMI") + theme(panel.grid.major = element_blank(),
  panel.grid.minor = element_blank(),plot.background=element_rect(fill = "gray"),
